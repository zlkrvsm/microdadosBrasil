...
One of the challenges when working with brazilian datasets is that they are both long and wide, contaning many observations and variables, with significant complexity. Most import and transform solutions favor speed, but require some programming proficiency to be understood and implemented. This package chooses to focus on ease-of-use rather than performance, since most data analysts will not benefit from marginal increases in speed, but will definitely feel more encouraged to use it for data analysis if the process is simplified.
