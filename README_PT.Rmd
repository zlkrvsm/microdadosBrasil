...
Uma das dificuldades com a importação de bancos de dados brasileiros é que eles combinam dois desafios simultâneos: são bancos com muitas observações e muitas variáveis. A maioria das soluções prioriza o desempenho e a velocidade de importação, mas envolvem certa proficiência em programação, o que afasta usuários novatos. Desta forma, este pacote prioriza a facilidade de uso em detrimento da velocidade, partindo do pressuposto de que o analista de dados não estará preocupado necessariamente com a forma mais rápida de importar e processar os dados, mas vai se sentir motivado para utilizar o software se o processo for simplificado.
